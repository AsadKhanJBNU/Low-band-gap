...
## Overview  
This project focuses on predicting low band gap semiconductors for organic solar cells using machine learning.  
The model integrates computational predictions with experimental validation to enhance solar cell performance.  
